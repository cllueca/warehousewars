...
urlpatterns = [
    ...
    path('etiqueta/<int:pedido_id>/', views.generate_etiqueta_pdf, name='generate_etiqueta_pdf'),
    path('update_order_status/<int:order_id>/<int:status_id>/', views.update_order_status, name='update_order_status'),

    path('cart/mandarPedido/<str:tipo_envio>/<str:transportista>/', views.mandarPedido, name='mandarPedido'),
    #path('cart/mandarPedido/', views.mandarPedido, name='mandarPedido'),
    path("delete_order/<int:order_id>/", views.delete_order, name="delete_order"),
    path('update_order_status/<int:order_id>/<int:status_id>/', views.update_order_status, name='update_order_status'),
    path('createRelation/<int:proveedor>/<int:producto>/', views.createRelation, name='createRelation'),
    path('eliminar_producto_pedido/<int:product_id>/', views.delete_product_proveedor, name='eliminar_producto_pedido'),
    ]
